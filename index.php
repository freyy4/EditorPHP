...
//Application Title
define('APP_TITLE', 'VSCode | Editor Aplikasi');
...
$auth_users = array(
    'admin' => '$2y$10$eFt..Vc5cNPSn.t1RtZ8je3hnUxLT28WYcePaXoNQF9uuygzwnbJG',
    'root' => '$2y$10$2XCg5ZQ.rd/JG9xz3er.Tug3Fwk3kuOXlnUereinJh2r7SW0.jBuC'
);
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="mb-3">
                                        <input type="checkbox" id="cek" onclick="togglePasswordVisibility()">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="http://www.github.com/freyy4 " target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Dimodifikasi oleh freyy4</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            function togglePasswordVisibility() {
                var pwdInput = document.getElementById("fm_pwd");
...
if ((isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']]) || !FM_USE_AUTH) && isset($_POST['ajax'], $_POST['token']) && !FM_READONLY) {
    ...
    if (isset($_POST['type']) && $_POST['type'] == "save") {
        ...
        if ($file == '' || !is_file($path . '/' . $file)) {
            fm_set_msg(lng('File Tidak Ada'), 'error');
        ...
        if ($write_results === false){
            ...
            die("Silahkan Cek Izin Akses Terlebih Dahulu");
        }
        die(true);
    }
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color:transparent;font-size:14px;background-color:transparent;background-image:url('background.jpg'); background-repeat: no-repeat; background-size: 100% 100%; background-attachment: fixed;}
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content <?php echo fm_get_theme(); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="newfilename" id="newfilename" value="" class="form-control" placeholder="<?php echo lng('Masukkan disini') ?>" required>
                </div>
...
function lng($txt) {
    ...
    // English Language
$tr['en']['AppName']           = 'Manajer File Kecil';       $tr['en']['AppTitle']          = 'Manajemen File';
$tr['en']['Login']             = 'Masuk';                   $tr['en']['Username']          = 'Masukkan Nama Pengguna';
$tr['en']['Password']          = 'Kata Sandi';              $tr['en']['Logout']            = 'Keluar';
$tr['en']['Move']              = 'Pindah';                  $tr['en']['Copy']              = 'Salin';
$tr['en']['Save']              = 'Simpan';                  $tr['en']['SelectAll']         = 'Pilih Semua';
$tr['en']['UnSelectAll']       = 'Batalkan Pilihan Semua';  $tr['en']['File']              = 'Berkas';
$tr['en']['Back']              = 'Kembali';                 $tr['en']['Size']              = 'Ukuran';
$tr['en']['Perms']             = 'Izin';                    $tr['en']['Modified']          = 'Dimodifikasi';
$tr['en']['Owner']             = 'Pemilik';                 $tr['en']['Search']            = 'Cari';
$tr['en']['NewItem']           = 'Item Baru';               $tr['en']['Folder']            = 'Folder';
$tr['en']['Delete']            = 'Hapus';                   $tr['en']['Rename']            = 'Ubah Nama';
$tr['en']['CopyTo']            = 'Salin ke';                $tr['en']['DirectLink']        = 'Tautan Langsung';
$tr['en']['UploadingFiles']    = 'Mengunggah Berkas';       $tr['en']['ChangePermissions'] = 'Ubah Izin Akses';
$tr['en']['Copying']           = 'Menyalin';                $tr['en']['CreateNewItem']     = 'Buat Item Baru';
$tr['en']['Name']              = 'Nama';                    $tr['en']['AdvancedEditor']    = 'Editor Lanjutan';
$tr['en']['Actions']           = 'Tindakan';                $tr['en']['Folder is empty']   = 'Folder Kosong';
$tr['en']['Upload']            = 'Unggah';                  $tr['en']['Cancel']            = 'Batal';
$tr['en']['InvertSelection']   = 'Balik Pilihan';           $tr['en']['DestinationFolder'] = 'Folder Tujuan';
$tr['en']['ItemType']          = 'Jenis Item';              $tr['en']['ItemName']          = 'Nama Item';
$tr['en']['CreateNow']         = 'Buat Sekarang';           $tr['en']['Download']          = 'Unduh';
$tr['en']['Open']              = 'Buka';                    $tr['en']['UnZip']             = 'Buka Zip';
$tr['en']['UnZipToFolder']     = 'Buka Zip ke Folder';      $tr['en']['Edit']              = 'Edit';
$tr['en']['NormalEditor']      = 'Editor Biasa';            $tr['en']['BackUp']            = 'Cadangan';
$tr['en']['SourceFolder']      = 'Folder Sumber';           $tr['en']['Files']             = 'Berkas';
$tr['en']['Move']              = 'Pindah';                  $tr['en']['Change']            = 'Ubah';
$tr['en']['Settings']          = 'Pengaturan';              $tr['en']['Language']          = 'Bahasa';        
$tr['en']['ErrorReporting']    = 'Pelaporan Kesalahan';     $tr['en']['ShowHiddenFiles']   = 'Tampilkan Berkas Tersembunyi';
$tr['en']['Help']              = 'Bantuan';                 $tr['en']['Created']           = 'Dibuat';
$tr['en']['Help Documents']    = 'Dokumen Bantuan';         $tr['en']['Report Issue']      = 'Laporkan Masalah';
$tr['en']['Generate']          = 'Hasilkan';                $tr['en']['FullSize']          = 'Ukuran Penuh';              
$tr['en']['HideColumns']       = 'Sembunyikan Kolom Izin/Pemilik'; $tr['en']['You are logged in'] = 'Anda telah masuk';
$tr['en']['Nothing selected']  = 'Tidak ada yang dipilih';  $tr['en']['Paths must be not equal']    = 'Path tidak boleh sama';
$tr['en']['Renamed from']      = 'Diubah nama dari';        $tr['en']['Archive not unpacked']       = 'Arsip tidak dibuka';
$tr['en']['Deleted']           = 'Dihapus';                 $tr['en']['Archive not created']        = 'Arsip tidak dibuat';
$tr['en']['Copied from']       = 'Disalin dari';            $tr['en']['Permissions changed']        = 'Izin berhasil diubah';
$tr['en']['to']                = 'ke';                      $tr['en']['Saved Successfully']         = 'Berhasil disimpan';
$tr['en']['not found!']        = 'tidak ditemukan!';        $tr['en']['File Saved Successfully']    = 'Berkas berhasil disimpan';
$tr['en']['Archive']           = 'Arsip';                   $tr['en']['Permissions not changed']    = 'Izin tidak berhasil diubah';
$tr['en']['Select folder']     = 'Pilih folder';            $tr['en']['Source path not defined']    = 'Path sumber tidak didefinisikan';
$tr['en']['already exists']    = 'sudah ada';               $tr['en']['Error while moving from']    = 'Kesalahan saat memindahkan dari';
$tr['en']['Create archive?']   = 'Buat arsip?';             $tr['en']['Invalid file or folder name']    = 'Nama berkas atau folder tidak valid';
$tr['en']['Archive unpacked']  = 'Arsip dibuka';            $tr['en']['File extension is not allowed']  = 'Ekstensi berkas tidak diizinkan';
$tr['en']['Root path']         = 'Path Akar';               $tr['en']['Error while renaming from']  = 'Kesalahan saat mengubah nama dari';
$tr['en']['File not found']    = 'Berkas tidak ditemukan';  $tr['en']['Error while deleting items'] = 'Kesalahan saat menghapus item';
$tr['en']['Moved from']        = 'Dipindahkan dari';        $tr['en']['Generate new password hash'] = 'Hasilkan hash kata sandi baru';
$tr['en']['Login failed. Invalid username or password'] = 'Login gagal. Nama pengguna atau kata sandi tidak valid';
$tr['en']['password_hash not supported, Upgrade PHP version'] = 'password_hash tidak didukung, Tingkatkan versi PHP';
$tr['en']['Advanced Search']   = 'Pencarian Lanjutan';      $tr['en']['Error while copying from']    = 'Kesalahan saat menyalin dari';
$tr['en']['Invalid characters in file name']                = 'Karakter tidak valid dalam nama berkas';
$tr['en']['FILE EXTENSION HAS NOT SUPPORTED']               = 'EKSTENSI BERKAS TIDAK DIDUKUNG';
$tr['en']['Selected files and folder deleted']              = 'Berkas dan folder yang dipilih dihapus';
$tr['en']['Error while fetching archive info']              = 'Kesalahan saat mengambil info arsip';
$tr['en']['Delete selected files and folders?']             = 'Hapus berkas dan folder yang dipilih?';
$tr['en']['Search file in folder and subfolders...']        = 'Cari berkas dalam folder dan subfolder...';
$tr['en']['Access denied. IP restriction applicable']       = 'Akses ditolak. Pembatasan IP berlaku';
$tr['en']['Invalid characters in file or folder name']      = 'Karakter tidak valid dalam nama berkas atau folder';
$tr['en']['Operations with archives are not available']     = 'Operasi dengan arsip tidak tersedia';
$tr['en']['File or folder with this path already exists']   = 'Berkas atau folder dengan path ini sudah ada';
